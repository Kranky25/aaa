...
public class PruebaFile extends JFrame
   ...
   // mostrar informaci�n acerca del archivo especificado por el usuario
   public void actionPerformed( ActionEvent eventoAccion )
   {
      File nombre = new File( eventoAccion.getActionCommand() );

      // si nombre existe, mostrar informaci�n sobre �l
      if ( nombre.exists() ) {
         ...
         // mostrar informaci�n si nombre es un archivo
         if ( nombre.isFile() ) {
